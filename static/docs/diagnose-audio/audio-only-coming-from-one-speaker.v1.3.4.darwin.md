If you are using a multi-channel device such as an audio interface or mixer, and others can only hear it from one side of their headphones/speaker, it's likely the device is in mono.
